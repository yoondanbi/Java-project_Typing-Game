...
- **게임 구성**
  - <p style="background-color: yellow; display: inline;">게임 화면</p>
    - 게임 진행 방식
  ...
  - <p style="background-color: yellow; display: inline;">시작 화면</p>
    - 게임 시작, 순위 확인, 단어 편집의 3가지 버튼으로 구성.
  - <p style="background-color: yellow; display: inline;">순위 확인 화면</p>
    - 사용자가 입력한 이름, 플레이 타임 내에 수집한 초콜릿 개수 순으로 순위 결정.
  - <p style="background-color: yellow; display: inline;">단어 편집 화면</p>
